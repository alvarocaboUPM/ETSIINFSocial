 ...
 */
        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
                ...
                es.upm.etsiinf.sos.LoginResponse loginResponse1 = null;
	                        es.upm.etsiinf.sos.Login wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), loginResponse1, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "login"));
                                    } else 
                ...
                es.upm.etsiinf.sos.RemoveUserResponse removeUserResponse3 = null;
	                        es.upm.etsiinf.sos.RemoveUser wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), removeUserResponse3, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "removeUser"));
                                    } else 
            ...
            if("getMyFriendStates".equals(methodName)){
                ...
                es.upm.etsiinf.sos.GetMyFriendStatesResponse getMyFriendStatesResponse5 = null;
	                        es.upm.etsiinf.sos.GetMyFriendStates wrappedParam =
                                                             (es.upm.etsiinf.sos.GetMyFriendStates)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getMyFriendStatesResponse5, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "getMyFriendStates"));
                                    } else 
                ...
                es.upm.etsiinf.sos.ChangePasswordResponse changePasswordResponse7 = null;
	                        es.upm.etsiinf.sos.ChangePassword wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), changePasswordResponse7, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "changePassword"));
                                    } else 
            ...
            if("getMyStates".equals(methodName)){
                ...
                es.upm.etsiinf.sos.GetMyStatesResponse getMyStatesResponse9 = null;
	                        es.upm.etsiinf.sos.GetMyStates wrappedParam =
                                                             (es.upm.etsiinf.sos.GetMyStates)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getMyStatesResponse9, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "getMyStates"));
                                    } else 
            ...
            if("getMyFriends".equals(methodName)){
                ...
                es.upm.etsiinf.sos.GetMyFriendsResponse getMyFriendsResponse11 = null;
	                        es.upm.etsiinf.sos.GetMyFriends wrappedParam =
                                                             (es.upm.etsiinf.sos.GetMyFriends)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getMyFriendsResponse11, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "getMyFriends"));
                                    } else 
            ...
            if("addFriend".equals(methodName)){
                ...
                es.upm.etsiinf.sos.AddFriendResponse addFriendResponse13 = null;
	                        es.upm.etsiinf.sos.AddFriend wrappedParam =
                                                             (es.upm.etsiinf.sos.AddFriend)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), addFriendResponse13, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "addFriend"));
                                    } else 
            ...
            if("publishState".equals(methodName)){
                ...
                es.upm.etsiinf.sos.PublishStateResponse publishStateResponse15 = null;
	                        es.upm.etsiinf.sos.PublishState wrappedParam =
                                                             (es.upm.etsiinf.sos.PublishState)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), publishStateResponse15, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "publishState"));
                                    } else 
            ...
            if("removeFriend".equals(methodName)){
                ...
                es.upm.etsiinf.sos.RemoveFriendResponse removeFriendResponse17 = null;
	                        es.upm.etsiinf.sos.RemoveFriend wrappedParam =
                                                             (es.upm.etsiinf.sos.RemoveFriend)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), removeFriendResponse17, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "removeFriend"));
                                    } else 
                ...
                es.upm.etsiinf.sos.AddUserResponse addUserResponse19 = null;
	                        es.upm.etsiinf.sos.AddUser wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), addUserResponse19, false, new javax.xml.namespace.QName("http://sos.etsiinf.upm.es",
                                                    "addUser"));
        ...
        //
            ...
            private  org.apache.axiom.om.OMElement  toOM(es.upm.etsiinf.sos.GetMyFriendStatesResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {
            ...
            throws org.apache.axis2.AxisFault {
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, es.upm.etsiinf.sos.GetMyFriendStatesResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(es.upm.etsiinf.sos.GetMyFriendStatesResponse.MY_QNAME,factory));
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, es.upm.etsiinf.sos.GetMyStatesResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(es.upm.etsiinf.sos.GetMyStatesResponse.MY_QNAME,factory));
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, es.upm.etsiinf.sos.GetMyFriendsResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(es.upm.etsiinf.sos.GetMyFriendsResponse.MY_QNAME,factory));
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, es.upm.etsiinf.sos.AddFriendResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(es.upm.etsiinf.sos.AddFriendResponse.MY_QNAME,factory));
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, es.upm.etsiinf.sos.PublishStateResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(es.upm.etsiinf.sos.PublishStateResponse.MY_QNAME,factory));
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, es.upm.etsiinf.sos.RemoveFriendResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(es.upm.etsiinf.sos.RemoveFriendResponse.MY_QNAME,factory));
        ...
        */
        ...
        try {
                ...
                if (es.upm.etsiinf.sos.GetMyFriendStatesResponse.class.equals(type)){
                           ...
                           return es.upm.etsiinf.sos.GetMyFriendStatesResponse.Factory.parse(param.getXMLStreamReaderWithoutCaching());
