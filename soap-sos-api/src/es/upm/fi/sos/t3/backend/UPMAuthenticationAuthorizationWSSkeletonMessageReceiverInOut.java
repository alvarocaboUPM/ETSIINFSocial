        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("addUser".equals(methodName)){
                ...
                es.upm.fi.sos.t3.backend.AddUserResponse addUserResponse1 = null;
	                        es.upm.fi.sos.t3.backend.AddUser wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), addUserResponse1, false, new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es",
                                                    "addUser"));
                                    } else 

            if("existUser".equals(methodName)){
                
                es.upm.fi.sos.t3.backend.ExistUserResponse existUserResponse3 = null;
	                        es.upm.fi.sos.t3.backend.ExistUser wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), existUserResponse3, false, new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es",
                                                    "existUser"));
                                    } else 

            if("login".equals(methodName)){
                
                es.upm.fi.sos.t3.backend.LoginResponse loginResponse5 = null;
	                        es.upm.fi.sos.t3.backend.Login wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), loginResponse5, false, new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es",
                                                    "login"));
                                    } else 

            if("removeUser".equals(methodName)){
                
                es.upm.fi.sos.t3.backend.RemoveUserResponse removeUserResponse7 = null;
	                        es.upm.fi.sos.t3.backend.RemoveUser wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), removeUserResponse7, false, new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es",
                                                    "removeUser"));
                                    } else 

            if("changePassword".equals(methodName)){
                
                es.upm.fi.sos.t3.backend.ChangePasswordResponse changePasswordResponse9 = null;
	                        es.upm.fi.sos.t3.backend.ChangePassword wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               changePasswordResponse9 =
                                                   
                                                   
                                                         skel.changePassword(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), changePasswordResponse9, false, new javax.xml.namespace.QName("http://backend.t3.sos.fi.upm.es",
                                                    "changePassword"));
